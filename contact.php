...
<div class="mainContentContainer">
    ...
    <div class="containerLinkItaliano">
      ...
      <a href="it/contact_it.php" target="_self">ITALIANO</a>
...
<div class="containerUniversalContent">
    	<div class="mainMenu">
        	<ul class="listMenuTimesNewRoman">
            	<li>
                	<a class="inactiveLink" href="index.html" target="_self">ACASA</a>
                </li>
                <li><a class="inactiveLink" href="despre_noi.html" target="_self">DESPRE NOI</a></li>
                <li><a class="inactiveLink" href="colectii_selection_page_main.html" target="_self">COLECTII</a></li>
                <li><a class="activeLink" href="despre_noi.html" target="_self">CONTACT</a></li>
            </ul>
        </div><!--ends mainMenu-->	
...
?>
    ...
    <div class="containerBottomContent">
    	<div class="contentWrapper285">
        	<h2>DESPRE NOI</h2>
            <p>Canapelele Divani&Sofa sunt creatii care apar din reflectia asupra dorintelor noi care ne conduc de a trai intr-un mod mai putin formal si a ne reinventa spatiile si functiile unui obiect.Cerintele atente si exigente ale clientilor ne-au dezvoltat un simt pentru tendintele modei.</p>
            <a href="despre_noi.html" target="_self">click aici pentru mai multe detalii</a>
        ...
        <div class="contentWrapper285">
            ...
            <ul>
            	<li>
                    ...
                    <a href="colectii_selection_page.html" target="_self">CLICK AICI PENTRU MAI MULTE DETALII</a>
                    <img class="breakLineBottomContent" src="images/break_line_bottom_content/break_line.jpg"/>
               	</li>
                <li>
                    <p class="increaseFontTitle">OUTDOOR</p>
                    <a href="colectii_selection_page_main_outdoor.html" target="_self">CLICK AICI PENTRU MAI MULTE DETALII</a>
                    <img class="breakLineBottomContent" src="images/break_line_bottom_content/break_line.jpg"/>
                </li>
               </ul>
                <a href="colectii_selection_page_main.html" target="_self">CLICK AICI PENTRU TOATE COLECTIILE</a>
        </div><!--ends contentWrapper285-->
